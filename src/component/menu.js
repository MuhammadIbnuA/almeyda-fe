...
const Penduduk = () => {
  ...
  const fetchPenduduk = async () => {
    try {
      ...
      const response = await axios.get('https://almeyda-be.vercel.app/penduduk', {
        headers: {
  ...
  const createPenduduk = async () => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.post('https://almeyda-be.vercel.app/penduduk', formData, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
  ...
  const updatePenduduk = async () => {
    try {
      ...
      const response = await axios.put(
        `https://almeyda-be.vercel.app/penduduk/${selectedPenduduk._id}`,
        formData,
        {
          headers: {
            Authorization: `Bearer ${token}`
  ...
  const deletePenduduk = async (id) => {
    try {
      const token = localStorage.getItem('token');
      const response = await axios.delete(`https://almeyda-be.vercel.app/penduduk/${id}`, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
